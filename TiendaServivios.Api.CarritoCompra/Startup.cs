...
using TiendaServivios.Api.CarritoCompra.Aplicacion;
using TiendaServivios.Api.CarritoCompra.Persistencia;
using TiendaServivios.Api.CarritoCompra.RemoteInterface;
using TiendaServivios.Api.CarritoCompra.RemoteService;

namespace TiendaServivios.Api.CarritoCompra
{
